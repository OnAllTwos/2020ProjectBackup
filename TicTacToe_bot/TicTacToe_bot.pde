/*
  An AI that I made that's pretty good at Tic-Tac-Toe!
  Based on the rules which "solved" tic-tac-toe.
  But if it went first every time then, by the very definition of tic-tac-toe being a solved game, then you would always lose.
  So I'll let you go first, and if you know how to win tic-tac-toe by the solved rules, then this is pretty easy to win.
*/
int borderWeight=10;
int whoseTurn = 0;
class ai{
