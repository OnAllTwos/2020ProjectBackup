...
public class TicTacToe_bot extends PApplet {
...
class ai{
  ...
  public void makeMove(PVector coord){
    if(this.crosses){
  ...
  public void checkWin(){  //THICC BOY
    int good=2;
    int other=1;
    if(!this.crosses){
      good = 1;
  ...
  public void checkThreats(){  //THICC BOY
    int bad = 1;
    int other = 2;
    if(!this.crosses){
      bad = 2;
...
public void loadAI(){
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "TicTacToe_bot" };
    if (passedArgs != null) {
